...
public class EventPlannerController {
	...
	@PutMapping("/{id}/edit")
	public EventPlanner editEventPlanner(@PathVariable Long id, @RequestBody UsuarioDTO dto) {
		return this.eventPlannerService.uptdateEventPlanner(id,dto);
	}
	
	@DeleteMapping("/{id}")
	public void deleteEventPlanner(@PathVariable Long id) {
		this.eventPlannerService.deleteEventPlanner(id);
	}
